...
/**
 * UsersIntegrationsJivositeApiController implements the CRUD actions for UsersIntegrationsJivositeApi model.
 */
class UsersIntegrationsJivositeApiController extends Controller
{
    /**
     * {@inheritdoc}
     */
    ...
    /**
     * Displays a single UsersIntegrationsJivositeApi model.
     * @param integer $id
     * @return mixed
    ...
    /**
     * Deletes an existing UsersIntegrationsJivositeApi model.
